...
class Robot:
    ...
    def __init__(self):
        ...
        self._axis = [
            Axis(Slush.Motor(1), minimum=-8000, maximum=5500, speed=10, current=[65, 65, 65, 65], steps=32000, negate=True), #Shoulder
            ...
            Axis(Slush.Motor(4), minimum=-4000, maximum=4000, speed=20, current=[85, 85, 85, 85], steps=14000, negate=True),
